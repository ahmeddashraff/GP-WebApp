                                    ...
                                    {reports && reports.map(report => (
                                        <div className="card shadow col-4">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <p className="m-0"><strong>Status: </strong><span className="">{report.status == 1 ? <p className="text-success mb-0"><strong>done</strong></p> :
                                                             (report.status == 0 ? <p className="text-secondary mb-0"><strong>in progress</strong></p> :
                                                            (report.status == 4 ? <p className="text-secondary mb-0"><strong>waiting</strong></p>: (report.status == 3 ? <p className="text-danger mb-0"><strong>not approved</strong></p>:
                                                            <p className="text-warning mb-0"><strong>pending</strong></p>)))}</span></p>
